...
yay -S --noconfirm bmenu perl-anyevent-i3 rofi zenity compton dunst i3exit spectacle polkit-gnome polkit-kde-agent pamac-gtk pamac-cli pamac-tray-appindicator clipit xautolock conky conky-i3 bumblebee-status pavucontrol pa-applet dmenu-manjaro checkupdates-aur python-i3ipc python-psutil xcwd-git python-pygit2 python-xkbgroup xkb-switch-i3 progress python-taskw python-requests octopi octopi-notifier-qt5 kate krusader spectacle kde-cli-tools ksystemlog ksysguard gnome-system-monitor gnome-system-log xclip xsel xdotool bitwarden-bin bitwarden-cli-bin bitwarden-rofi

# applications
yay -S ungit gitahead-bin
