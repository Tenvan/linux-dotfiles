...
values."
  (setq-default
   ...
   dotspacemacs-frozen-packages '(prettier-js)
...
(defun dotspacemacs/user-config ()
  "Configuration function for user 0code.
...
you should place your code here."
  ...
  "indenting"
  (global-set-key (kbd "M-<f8>")    'spacemacs/indent-region-or-buffer)
