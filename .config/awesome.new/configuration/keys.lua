...
awful.keyboard.append_global_keybindings({
	...
	---------
	-- Restart awesome
	awful.key({ mod, ctrl }, "r", awesome.restart, { description = "reload awesome", group = kgAwesome }),

	-- Quit awesome
	awful.key({ mod, ctrl }, "q", awesome.quit, { description = "quit awesome", group = kgAwesome }),

	-- Show help
	awful.key({ mod }, "F1", hotkeys_popup.show_help, { description = "show Help", group = kgAwesome }),
...
client.connect_signal("request::default_keybindings", function()
	awful.keyboard.append_client_keybindings({
		...
		-- Toggle floating
		awful.key({ mod, ctrl }, spacekey, awful.client.floating.toggle),
