...
local base06 = "#abadaf" -- +++
local base07 = "#a8bed3" -- ++++
local base08 = "#f6933f" -- red
local base09 = "#b0b23c" -- orange
local base0A = "#c8a966" -- yellow
local base0B = "#1bc36f" -- green
local base0C = "#36bdbb" -- aqua/cyan
local base0D = "#4bb8dc" -- blue
local base0E = "#e38fdd" -- purple
local base0F = "#bf8e29" -- brown
