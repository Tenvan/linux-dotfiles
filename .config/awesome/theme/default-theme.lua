...
local awesome_overrides = function(theme)
  ...
  theme.titlebar_close_button_normal_hover = tip .. 'close_normal_hover.' .. tie
  theme.titlebar_close_button_focus_hover  = tip .. 'close_focus_hover.' .. tie

  -- Hovered Minimize Buttin
  theme.titlebar_minimize_button_normal_hover = tip .. 'minimize_normal_hover.' .. tie
  theme.titlebar_minimize_button_focus_hover  = tip .. 'minimize_focus_hover.' .. tie

  -- Hovered Ontop Button
  theme.titlebar_ontop_button_normal_inactive_hover = tip .. 'ontop_normal_inactive_hover.' .. tie
  theme.titlebar_ontop_button_focus_inactive_hover  = tip .. 'ontop_focus_inactive_hover.' .. tie
  theme.titlebar_ontop_button_normal_active_hover   = tip .. 'ontop_normal_active_hover.' .. tie
  theme.titlebar_ontop_button_focus_active_hover    = tip .. 'ontop_focus_active_hover.' .. tie

  -- Hovered Sticky Button
  theme.titlebar_sticky_button_normal_inactive_hover = tip .. 'sticky_normal_inactive_hover.' .. tie
  theme.titlebar_sticky_button_focus_inactive_hover  = tip .. 'sticky_focus_inactive_hover.' .. tie
  theme.titlebar_sticky_button_normal_active_hover   = tip .. 'sticky_normal_active_hover.' .. tie
  theme.titlebar_sticky_button_focus_active_hover    = tip .. 'sticky_focus_active_hover.' .. tie

  -- Hovered Floating Button
  theme.titlebar_floating_button_normal_inactive_hover = tip .. 'floating_normal_inactive_hover.' .. tie
  theme.titlebar_floating_button_focus_inactive_hover  = tip .. 'floating_focus_inactive_hover.' .. tie
  theme.titlebar_floating_button_normal_active_hover   = tip .. 'floating_normal_active_hover.' .. tie
  theme.titlebar_floating_button_focus_active_hover    = tip .. 'floating_focus_active_hover.' .. tie

  -- Hovered Maximized Button
  theme.titlebar_maximized_button_normal_inactive_hover = tip .. 'maximized_normal_inactive_hover.' .. tie
  theme.titlebar_maximized_button_focus_inactive_hover  = tip .. 'maximized_focus_inactive_hover.' .. tie
  theme.titlebar_maximized_button_normal_active_hover   = tip .. 'maximized_normal_active_hover.' .. tie
  theme.titlebar_maximized_button_focus_active_hover    = tip .. 'maximized_focus_active_hover.' .. tie
