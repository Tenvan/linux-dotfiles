...
awful.screen.connect_for_each_screen(
  function(s)
    ...
    if (s.index == 2) then
      ...
      beautiful.other_screen_connect(s)
    end
  end
)
-- }}}
...
globalkeys =
  ...
  awful.key({altkey}, "Escape", awful.tag.history.restore, {description = "go back", group = kgTag}), -- Tag browsing alt + tab
