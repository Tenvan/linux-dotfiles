...
client.connect_signal('raised', function(c)
  ...
  log(' -> client minimized.: ' .. tostring(c.minimized))
  log(' -> client sticky....: ' .. tostring(c.sticky))
  log(' -> client ontop.....: ' .. tostring(c.ontop))
  log(' -> client above.....: ' .. tostring(c.above))
  log(' -> client below.....: ' .. tostring(c.below))
  log(' -> client modal.....: ' .. tostring(c.modal))
  log('======================' .. tostring(c.role))
